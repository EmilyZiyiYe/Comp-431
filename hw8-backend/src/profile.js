...
const getHeadlines = (req, res) => {
	//parse the supplied users and include them into a list
...
const putHeadline = (req, res) => {
	...
	//update the headline with the supplied text
...
const putAvatar = (req,res) => {
	...
	models.Profile.update({username: username}, {$set: { avatar: avatar}}, { new: true }, function(err){
		if (err) {
			return console.log(err)
		}
		else{
...
module.exports = app => {
	 ...
	 app.put('/avatar', uploadImg('image'), putAvatar)
}