...
public interface GList<T> {
  ...
  // This week we're also introducing a bunch of code
  ...
  // Both of these annotations, when applied at the top, outside of the class or interface,
  // then apply to every single method within the class. This avoids a lot of clutter.
  ...
  static GList<Integer> rangeInt(int start, int end, int increment) {
    ...
    // HINT: create a helper method so you can deal with incrementing vs. decrementing lists
