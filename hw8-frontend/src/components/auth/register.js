      ...
      <div id="panel panel-default">   
            ...
            <div id="panel-body text-center">  
                  <div className="form-group row">
                    <b>Account Name:</b>
                    <input id="register_username" type="text" name="username" placeholder="Must start with a letter" ref={(node) => { username = node }}/ >  
                  </div>
                  <div className="form-group row">
                  ...
                  <div className="form-group row">
                    <b>Date of Birth:</b>
                    <input id="register_dob" type="text" name="dateofbirth" placeholder="MM/DD/YYYY" required ref={(node) => { birth = node }}/>  
                  </div>
                  <div className="form-group row">
                    <b>Zipcode :</b>
